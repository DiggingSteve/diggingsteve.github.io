<template>
    <svg xmlns="http://www.w3.org/2000/svg" class="lds-bluecat" width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
      <g transform="rotate(283.314 50 50)">
      ...
      <g transform="rotate(325.582 50 50)">
